...
- [`config/routes.rb`](https://github.com/arkenidar/wsite/blob/main/config/routes.rb) — the URL map; the entry point for every request.
- [`app/controllers/`](https://github.com/arkenidar/wsite/blob/main/app/controllers/) — controllers (request handlers).
- [`app/models/`](https://github.com/arkenidar/wsite/blob/main/app/models/) — domain models (ActiveRecord).
- [`app/views/`](https://github.com/arkenidar/wsite/blob/main/app/views/) — templates (ERB).
- [`config/`](https://github.com/arkenidar/wsite/blob/main/config/) — app, environment, and database configuration.
- [`db/`](https://github.com/arkenidar/wsite/blob/main/db/) — migrations, schema, and seeds.
- [`test/`](https://github.com/arkenidar/wsite/blob/main/test/) — the test suite.

## The mental model

A request flows **route → controller action → (model) → view**:

1. [`config/routes.rb`](https://github.com/arkenidar/wsite/blob/main/config/routes.rb) matches the URL to a `controller#action`.
