...
- **Ruby** managed by [rbenv](https://github.com/rbenv/rbenv) (this repo uses the version
  pinned in [`.ruby-version`](https://github.com/arkenidar/wsite/blob/main/.ruby-version)). In a non-login shell you may need to load it:
...
See the project [README](https://github.com/arkenidar/wsite/blob/main/README.md) for a high-level overview.
