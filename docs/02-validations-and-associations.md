...
Add validations and the association to [`app/models/post.rb`](../app/models/post.rb):
...
Add a validation to [`app/models/comment.rb`](../app/models/comment.rb) (the generator
...
- [`app/models/post.rb`](../app/models/post.rb) — validations + `has_many :comments, dependent: :destroy`.
- [`app/models/comment.rb`](../app/models/comment.rb) — `belongs_to :post` + body validation.
- [`db/migrate/20260621213241_create_comments.rb`](../db/migrate/20260621213241_create_comments.rb) — `comments` table with `t.references :post, null: false, foreign_key: true`.
